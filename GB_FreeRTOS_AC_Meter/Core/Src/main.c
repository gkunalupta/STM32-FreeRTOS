...
/* USER CODE BEGIN Header_HLW8012_func */
/**
* @brief Function implementing the HLW8012 thread.
* @param argument: Not used
* @retval None
*/
...
/* USER CODE BEGIN Header_ESP8266_func */
/**
